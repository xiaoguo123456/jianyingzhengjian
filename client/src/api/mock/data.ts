...
export const CATEGORIES: Category[] = [
  ...
  { id: 'c_consultant', module: 'pro', name: '顾问', icon: 'user-check', cover_url: M('pro_consultant'), desc: '半身·浅色背景' },
  { id: 'c_doctor', module: 'pro', name: '医生', icon: 'shield', cover_url: M('pro_doctor'), desc: '白大褂·浅灰背景' },
  ...
  { id: 'c_chinese', module: 'portrait', name: '新中式', cover_url: M('portrait_chinese2'), desc: '国风 · 庭院' },
  { id: 'c_birthday', module: 'portrait', name: '生日写真', cover_url: M('portrait_birthday2'), desc: '气球 · 蛋糕' },
  ...
  { id: 'c_fresh', module: 'avatar', name: '清新自然', icon: 'leaf', cover_url: M('avatar_fresh'), desc: '1:1·户外' },
...
export const TEMPLATES: Template[] = [
  tpl('t_interview', 'pro', '面试职业照', 'pro_interview', 'c_interview', '深蓝西装 · 半身 · 3:4', { tags: ['热门'] }),
  ...
  tpl('t_website', 'pro', '官网头像', 'pro_website', 'c_website', '深灰西装 · 半身 · 3:4'),
  tpl('t_consultant', 'pro', '顾问形象照', 'pro_consultant', 'c_consultant', '深蓝西装 · 浅灰背景 · 3:4', { tags: ['上新'] }),
  tpl('t_doctor', 'pro', '医生形象照', 'pro_doctor', 'c_doctor', '白大褂 · 浅灰背景 · 3:4'),
  ...
  tpl('t_chinese', 'portrait', '新中式写真', 'portrait_chinese2', 'c_chinese', '国风 · 庭院 · 3:4', { tags: ['热门'] }),
  tpl('t_birthday', 'portrait', '清新生日照', 'portrait_birthday2', 'c_birthday', '气球 · 蛋糕 · 3:4', { tags: ['上新'] }),
  tpl('t_korean', 'portrait', '韩系清透写真', 'portrait_korean', 'c_korean', '自然光 · 户外 · 3:4'),
  tpl('t_french', 'portrait', '法式氛围写真', 'portrait_french', 'c_french', '窗边 · 胶片感 · 3:4'),
  ...
  tpl('t_av_illust', 'avatar', '插画头像', 'avatar_illust', 'c_illust', '二次元 · 1:1', { style: 'illustration', tags: ['上新'] }),
  tpl('t_av_fresh', 'avatar', '清新自然头像', 'avatar_fresh', 'c_fresh', '户外 · 1:1'),
]

export const COLLECTIONS: Collection[] = [
  { id: 'col_light', module: 'portrait', name: '自然光 · 轻写真', cover_url: M('collection_light'), desc: '自然光，少修饰', template_count: 4 },
  { id: 'col_mood', module: 'portrait', name: '城市里的电影感', cover_url: M('collection_mood'), desc: '胶片感与暗调', template_count: 3 },
  { id: 'col_half', module: 'portrait', name: '半身写真', cover_url: M('portrait_autumn'), desc: '半身构图', template_count: 3 },
  { id: 'col_festival', module: 'portrait', name: '节日主题', cover_url: M('portrait_birthday2'), desc: '生日与节日', template_count: 2 },
]

export const COLLECTION_TEMPLATE_IDS: Record<string, string[]> = {
  col_light: ['t_korean', 't_french', 't_autumn', 't_street'],
  col_half: ['t_autumn', 't_chinese', 't_korean'],
  col_festival: ['t_birthday', 't_chinese'],
  col_mood: ['t_street', 't_french', 't_autumn'],
}

export const BANNERS: Record<string, Banner> = {
  idphoto: { title: '制作标准\n证件照', subtitle: '', image_url: M('banner_id'), link: { type: 'upload' } },
  pro: { title: '你的下一张\n职业形象照', subtitle: '', image_url: M('banner_pro'), link: { type: 'upload' } },
  portrait: { title: '自然光写真', subtitle: '', image_url: M('banner_portrait'), link: { type: 'upload' } },
  avatar: { title: '换一张\n专属头像', subtitle: '', image_url: M('banner_avatar'), link: { type: 'upload' } },
}
